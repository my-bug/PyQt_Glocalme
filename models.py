...
class G4S(Glocalme):
    ...
    def pull_AllLog(self, save_file):
        subprocess.getoutput(' '.join([self.adb, 'pull /sdcard/logs/', save_file]))
        subprocess.getoutput(' '.join([self.adb, 'pull /sdcard/uaflogs/', save_file]))
...
class G3(Glocalme):
    def pullUcLog(self, save_file):
        subprocess.getoutput(' '.join([self.adb, 'pull /data/uclog/uC_Log.log', save_file]))

class U3X(Glocalme):
    def root(self):
        self.root_by_broadcast()
...
if __name__ == '__main__':
    s1 = G4S()
    s1.root()
    # s1.pull_AllLog('F:\\1-项目\\1-高通平台\G4S\log\\00000')
    # cmd = 'adb pull /sdcard/logs/ F:\\1-项目\\1-高通平台\G4S\log\\00000'
    # cmd01 = str(cmd, encoding'utf-8')
    # subprocess.getoutput('adb pull /sdcard/logs/ F:\\1-项目\\1-高通平台\G4S\log\\00000')